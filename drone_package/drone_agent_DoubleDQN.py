...
def main(args=None):
   ...
   agent = Agent(gamma=0.99, epsilon=1.0, alpha=0.0005, input_dims=(84,84,1), n_actions=4, mem_size=1000, batch_size=10, epsilon_end=0.01, replace_target=10, fname='/home/blue02/Desktop/Results/DoubleDQN/double_dqn_model.keras')
   control = Control(yaw=10.0, roll=10.0, throttle=10.0)
   environment = Environment(state_shape=(84,84,1))

   rclpy.init(args=args)
   drone_agent = DroneAgent_DoubleDQN(drone_id=d_id, agent=agent, control=control, environment=environment, n_episodes=50, save_path="/home/blue02/Desktop/Results/")
